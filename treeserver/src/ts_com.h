...
#define pkTS_ASQL						'Q'
	#define msgFAST_ASQL				'Q'
		...
		#define cmTS_GET_DICT_INFO		0x2101
		#define cmTS_PUT_DICT_INFO		0x2102

	#define msgASQL_TYPE_A				'A'
	#define msgASQL_TYPE_B				'B'
	#define msgASQL_TYPE_C				'C'
	#define msgASQL_TYPE_D				'D'
...
#define pkTS_USER						'U'
	...
	#define msgTS_USER_MANAGE			'M'
		...
		#define cmTS_USER_LIST			0x4020

	#define msgTS_REGISTERED_USER		'Q'
	#define msgTS_IDENTICAL_USER_NUM	'N'

//###################################################
#define pkTS_PRIVATE_ENG				'A'

#define pkTS_BACKUP						'B'
	#define msgTS_BACKUP_NOTIFY			'B'
	#define msgTS_RESTORE_NOTIFY		'R'
	#define msgTS_BACKUP_REPLAY			'A'
		#define cmTS_WAIT_READY			0x5001
		#define cmTS_FORCE_READY		0x5002
		#define cmTS_BACKUP_READY		0x5003
		#define cmTS_RESTORE_READY		0x5004
